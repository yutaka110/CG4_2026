...
class CourseRailViewportEditTool;
class CourseRailTransformGizmo;
class CourseEnemyEditorController;
class CourseEnemyViewportEditTool;
class CourseEnemyTransformGizmo;
...
struct EditorContext {
    ...
    CourseRailViewportEditTool* courseRailEditTool = nullptr;
    CourseRailTransformGizmo* courseRailTransformGizmo = nullptr;
    CourseEnemyEditorController* courseEnemyEditorController = nullptr;
    CourseEnemyViewportEditTool* courseEnemyEditTool = nullptr;
    CourseEnemyTransformGizmo* courseEnemyTransformGizmo = nullptr;
    const CourseEnemyPickingService* courseEnemyPickingService = nullptr;
    CourseEnemyViewportRenderer* courseEnemyViewportRenderer = nullptr;
    CourseWaveEditorController* courseWaveEditorController = nullptr;
    const CourseWavePickingService* courseWavePickingService = nullptr;
    CourseWaveViewportRenderer* courseWaveViewportRenderer = nullptr;
    CoursePreviewSimulationSystem* coursePreviewSimulationSystem = nullptr;
    CoursePreviewActorRuntimeBridge* coursePreviewActorRuntimeBridge = nullptr;
